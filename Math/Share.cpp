...
{
//	word s1 = S.get_share().get(0);
//	word s2 = S.get_mac().get(0);
//	word val = aa.get(0);
//	cout << "[Share.cpp] test" << endl;
//	cout << "[Share.cpp] S.get_share().get() = " << s1 << endl;
//	cout << "[Share.cpp] S.get_mac().get() = " << s2 << endl;
//	cout << "[Share.cpp] aa.get() = " << val << endl;
